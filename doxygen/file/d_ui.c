...
/**
 * @file
 * @brief this file contais the function for the menù.
*/
...
***************/
/**
 * @brief function to print the font of the map.
 * @param frame pointer with the lvl information
 * @param f pointer with the files of the map
*/
...
/**
 * @brief function to start the selected option
 * @param g pointer of game
 * @param quit pointer for quit the game
*/
