...
/**
 * @file
 * @brief contain function for menage the window
*/
/**
 ...
 * @param h values of heigth
 * @param w value of width
 * @param centered center of the window
 * @return a new window.
*/
...
/**
 * @brief Stack to windows on top of each other
 * @param main pointer of the principal windows
 * @param moving pointer of the moving 
...
/**
 * @brief set the border of the window
 * @param win pointer of the window
*/
...
/**
 * @brief Print a string at the center of the screen only in the x axe
 * @param win pointer of the window
